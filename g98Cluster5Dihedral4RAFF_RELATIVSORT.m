...
x=xlsread('x5_coordStore_tersoffOLD.xls');%read x coordinates
y=xlsread('y5_coordStore_tersoffOLD.xls');%read y coordinates
z=xlsread('z5_coordStore_tersoffOLD.xls');%read z coordinates
