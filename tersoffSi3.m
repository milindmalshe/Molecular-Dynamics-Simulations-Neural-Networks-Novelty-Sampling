...
function [Vij,DEDmov] = tersoffSi3(coord,total,numMov,movAtom,type);

% global x y z;
% global A  B lamda1 lamda2 lamda3 alpha beta eta c d h R D rCutoff;
% global lamda1 lamda2 lamda3 alpha beta eta c d h R D rCutoff;
...
param = [lamda1;ladma2;lamda3;alpha;beta;eta;c;d;h];
...
global lamda1 lamda2 lamda3 alpha beta n c d h R D;
