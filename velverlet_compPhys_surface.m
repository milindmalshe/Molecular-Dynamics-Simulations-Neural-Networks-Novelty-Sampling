...
function [coord,vel,accelrnNEW,tersoff_PE,KE]= velverlet_compPhys_surface(count,coord,total,numMov,numPeriph,numBound,numSurface,movAtom,periphAtom,boundAtom,surfaceAtom,vel,accelrn,mass);
